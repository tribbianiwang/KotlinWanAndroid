...
class RvSearchHistoryAdapter(hotSearchData: List<SearchHistoryKeyDaoBean>) :RecyclerView.Adapter<RvSearchHistoryAdapter.ViewHolder>(){
    var hotSearchData:List<SearchHistoryKeyDaoBean>
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.tv_key.text = hotSearchData.get(position).searchKey
